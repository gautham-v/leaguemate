...
const STATUS_COLORS: Record<string, string> = {
  ...
  'buy-low':          'bg-orange-900/40 text-orange-800 dark:text-orange-300 border-orange-800/50',
  ...
  'good-fit':         'bg-blue-900/40 text-blue-800 dark:text-blue-300 border-blue-800/50',
